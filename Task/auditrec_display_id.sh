...
auditrec_display () {
    ...
    echo "<br>"
    echo '<pre>'
    sudo /opt/butler_server/erts-11.1.1/bin/escript /usr/lib/cgi-bin/rpc_call.escript station_recovery audit_summary "[{'display_id',$1}]."      
    echo '</pre>'
}
...
echo '<title>Get Audit details by Display_id</title>' 
...
echo '<span class="details">Enter Audit Display id</span>' 
echo '<input type="number" name="display_id" style="padding-right:6px" size=12 placeholder="display_id" required>' 
echo '</div>' 

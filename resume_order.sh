...
resume_order () {
    ...
    echo "<br>"
    echo '<pre>'
    sudo /opt/butler_server/erts-11.1.1/bin/escript /usr/lib/cgi-bin/rpc_call.escript station_recovery resume_orders "[<<\"$1\">>]."
    echo '</pre>'
...
echo '<span class="details"style="margin-right:-40px>Enter ORDER_ID to Resume</span>' 

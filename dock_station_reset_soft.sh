...
dock_station_reset_soft () {
    ...
    echo "<br>"
    echo '<pre>'
    sudo /opt/butler_server/erts-11.1.1/bin/escript /usr/lib/cgi-bin/rpc_call.escript station_recovery reset_dockstation_soft "[$1]."
    echo '</pre>'
}
...
echo '<title>Reset Dock station Soft</title>' 
...
echo '<span class="details">Enter Dockstation_ID</span>' 
echo '<input type="number" name="Dockstation_ID" style="padding-right:6px" size=12 placeholder="Dockstation_ID" required>' 
echo '</div>' 

...
init_charger (){
    ...
    echo "<br>"
    sudo /opt/butler_server/erts-11.1.1/bin/escript /usr/lib/cgi-bin/rpc_call.escript charger_functions remove_blacklist_chargers "[[$1]]."
...
echo '<title>send charger init</title>' 

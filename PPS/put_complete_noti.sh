...
put_notification () {
    ...
    echo "<br>"
    echo '<pre>'
    sudo /opt/butler_server/erts-11.1.1/bin/escript /usr/lib/cgi-bin/rpc_call.escript station_recovery send_notification "[{'put_complete',<<\"$1\">>}]."
    echo '</pre>'
...
echo '<span class="details">Enter PUT_ID</span>' 
echo '<input type="number" name="PUT_ID" style="padding-right:6px" size=12 placeholder="PUT_ID" required>' 
echo '</div>' 

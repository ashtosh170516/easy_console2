...
echo '<title>Remove emergency_stop</title>' 
...
echo '<input type="number" name="CONTROLLER_ID" style="padding-right:6px" size=12 placeholder="controller id" required>' 
echo '</div>' 

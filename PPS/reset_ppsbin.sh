...
reset_pps_bin () {
    ...
    echo "<br>"
    sudo /opt/butler_server/erts-11.1.1/bin/escript /usr/lib/cgi-bin/rpc_call.escript station_recovery reset_bins "[{'bins',[{$1,\""$2"\"}]}]."
}
...
echo '<span class="details">Enter BIN_ID</span>' 

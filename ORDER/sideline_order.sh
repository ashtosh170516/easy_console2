...
sideline_order () {
    ...
    echo "<br>"
    echo '<pre>'
    sudo /opt/butler_server/erts-11.1.1/bin/escript /usr/lib/cgi-bin/rpc_call.escript station_recovery sideline_orders "[<<\"$1\">>]."
    echo '</pre>'
...
echo '<title>sideline_orders</title>' 
...
echo '<span class="details"style="padding-right:11px">Enter ORDER_ID to Sideline</span>' 

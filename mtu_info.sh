...
mtu_info () {
    ...
    echo "<br>"
    echo '<pre>'
    sudo /opt/butler_server/erts-11.1.1/bin/escript /usr/lib/cgi-bin/rpc_call.escript ims_mtu_functions get_mtu_info "[<<\"$1\">>]."
    echo '</pre>'
}
...
echo '<span class="details">Enter MTU_ID</span>' 
echo '<input type="number" name="MTU_ID" style="padding-right:6px" size=12 placeholder="MTU_ID" required>' 
echo '</div>' 
